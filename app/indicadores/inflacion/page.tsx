...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://argenstats.com/og-ipc.jpg',
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      images: ['https://argenstats.com/og-ipc.jpg'],
    },
    alternates: {
      canonical: 'https://argenstats.com/indicadores/inflacion',
    },
  }
}
    ...
    <>
      ...
      <StructuredData 
        data={BreadcrumbSchema([
          ...
          { name: "Inflación", url: "https://argenstats.com/indicadores/inflacion" }
        ])} 
